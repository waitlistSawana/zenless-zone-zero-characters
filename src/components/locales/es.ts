export default {
  ...
  dashboard: {
    ...
    settings: {
      ...
      general: {
        ...
        goals: "Objetivos",
        goals_description: "Establece tus objetivos semanales y mensuales.",
  ...
  landing: {
    hero: {
      ...
      launch: "mercado",
      title: "One Page Web Application",
      description:
        "Start up your tool webapp in a minimal style. Get better SEO room at the same time!",
      business: "tu negocio",
