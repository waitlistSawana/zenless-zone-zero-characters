  ...
  const Heading = () => (
    <div className="relative z-10 my-12 flex flex-col items-center justify-center gap-4">
      <div className="flex w-full flex-col items-start justify-center space-y-4 md:items-center">
        ...
        <p className="mt-2 text-3xl font-bold tracking-tight text-zinc-800 dark:text-zinc-200 sm:text-4xl">
        ...
        <button
          ...
          className={cn(
            ...
            billingCycle === "M"
              ...
              : "text-zinc-700 hover:bg-red-100 dark:text-zinc-300 dark:hover:text-black",
          )}
        >
          Monthly
  ...
  const PricingCards = () => (
    <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-8 lg:flex-row lg:gap-4">
      {pricingPlans.map((plan, index) => (
        <div
          key={index}
          className="w-full rounded-xl border-[1px] border-zinc-300 p-6 text-left dark:border-zinc-600"
        >
          <p className="mb-1 mt-0 text-sm font-medium uppercase text-red-500">
            {plan.name}
          </p>
          <p className="my-0 mb-6 text-sm text-zinc-600">{plan.description}</p>
          <div className="mb-8 overflow-hidden">
            <AnimatePresence mode="wait">
              <motion.p
                ...
                className="my-0 text-3xl font-semibold text-zinc-900 dark:text-zinc-100"
              >
                <span>
...
export default function LandingpagePricing2() {
  return <Pricing />;
}
